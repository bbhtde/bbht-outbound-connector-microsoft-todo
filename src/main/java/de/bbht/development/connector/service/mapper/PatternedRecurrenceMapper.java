...
public final class PatternedRecurrenceMapper {
  ...
  public static PatternedRecurrenceDto mapPatternedRecurrence(
    ...
    if (patternedRecurrence != null) {
      ...
      patternedRecurrenceDto.setPattern(
          RecurrencePatternMapper.mapRecurrencePattern(patternedRecurrence.getPattern()));
      patternedRecurrenceDto.setRange(
          RecurrenceRangeMapper.mapRecurrenceRange(patternedRecurrence.getRange()));
    }
    return patternedRecurrenceDto;
  }

  public static PatternedRecurrence mapPatternedRecurrenceDto(
      PatternedRecurrenceDto patternedRecurrenceDto) {
    PatternedRecurrence patternedRecurrence = null;
    if (patternedRecurrenceDto != null) {
      patternedRecurrence = new PatternedRecurrence();
      patternedRecurrence.setPattern(
          RecurrencePatternMapper.mapRecurrencePatternDto(patternedRecurrenceDto.getPattern()));
      patternedRecurrence.setRange(
          RecurrenceRangeMapper.mapRecurrenceRangeDto(patternedRecurrenceDto.getRange()));
    }
