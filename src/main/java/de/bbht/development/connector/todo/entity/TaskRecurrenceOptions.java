...
public record TaskRecurrenceOptions(@TemplateProperty(group = "recurrence",
                                                      ...
                                                      choices = {
                                                          @DropdownPropertyChoice(label = "Task is not recurring",
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      type = PropertyType.Dropdown,
                                                      choices = {
                                                          @DropdownPropertyChoice(label = "Daily",
                                                                                  value = "DAILY"),
                                                          @DropdownPropertyChoice(label = "Weekly",
                                                                                  value = "WEEKLY"),
                                                          @DropdownPropertyChoice(label = "Monthly (absolute)",
                                                                                  value = "ABSOLUTE_MONTHLY"),
                                                          @DropdownPropertyChoice(label = "Monthly (relative)",
                                                                                  value = "RELATIVE_MONTHLY"),
                                                          @DropdownPropertyChoice(label = "Yearly (absolute)",
                                                                                  value = "ABSOLUTE_YEARLY"),
                                                          @DropdownPropertyChoice(label = "Yearly (relative)",
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      condition = @PropertyCondition(property = "taskRecurrenceOptions.patternType",
                                                                                     oneOf = {
                                                                                         "ABSOLUTE_MONTHLY",
                                                                                         "ABSOLUTE_YEARLY"})) Integer dayOfMonth,
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      condition = @PropertyCondition(property = "taskRecurrenceOptions.patternType",
                                                                                     oneOf = {
                                                                                         "WEEKLY",
                                                                                         "RELATIVE_MONTHLY",
                                                                                         "RELATIVE_YEARLY"})) String daysOfWeek,
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      type = PropertyType.Dropdown,
                                                      choices = {
                                                          @DropdownPropertyChoice(label = "Sunday",
                                                                                  value = "SUNDAY"),
                                                          @DropdownPropertyChoice(label = "Monday",
                                                                                  value = "MONDAY"),
                                                          @DropdownPropertyChoice(label = "Tuesday",
                                                                                  value = "TUESDAY"),
                                                          @DropdownPropertyChoice(label = "Wednesday",
                                                                                  value = "WEDNESDAY"),
                                                          @DropdownPropertyChoice(label = "Thursday",
                                                                                  value = "THURSDAY"),
                                                          @DropdownPropertyChoice(label = "Friday",
                                                                                  value = "FRIDAY"),
                                                          @DropdownPropertyChoice(label = "Saturday",
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      type = PropertyType.Dropdown,
                                                      choices = {
                                                          @DropdownPropertyChoice(label = "First",
                                                                                  value = "FIRST"),
                                                          @DropdownPropertyChoice(label = "Second",
                                                                                  value = "SECOND"),
                                                          @DropdownPropertyChoice(label = "Third",
                                                                                  value = "THIRD"),
                                                          @DropdownPropertyChoice(label = "Fourth",
                                                                                  value = "FOURTH"),
                                                          @DropdownPropertyChoice(label = "Last",
                                    ...
                                    @TemplateProperty(group = "recurrence",
                                                      ...
                                                      condition = @PropertyCondition(property = "taskRecurrenceOptions.recurring",
                                                                                     equals = TaskRecurrenceOptions.VALUE_RECURRING),
                                                      choices = {
                                                          @DropdownPropertyChoice(label = "End Date",
                                                                                  value = "END_DATE"),
                                                          @DropdownPropertyChoice(label = "No End",
                                                                                  value = "NO_END"),
                                                          @DropdownPropertyChoice(label = "Numbered ",
