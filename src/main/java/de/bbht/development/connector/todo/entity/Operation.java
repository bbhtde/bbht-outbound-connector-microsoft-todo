...
public record Operation(@NotNull() @TemplateProperty(group = "operation",
    ...
    choices = {@DropdownPropertyChoice(value = "LIST_TASK_LISTS",
        label = "Get List of Task Lists"), @DropdownPropertyChoice(value = "GET_TASK_LIST",
        label = "Get Task List"), @DropdownPropertyChoice(value = "CREATE_TASK_LIST",
        label = "Create Task List"), @DropdownPropertyChoice(value = "UPDATE_TASK_LIST",
        label = "Update Task List"), @DropdownPropertyChoice(value = "DELETE_TASK_LIST",
        label = "Delete Task List"), @DropdownPropertyChoice(value = "LIST_TASKS",
        label = "Get List of Tasks"), @DropdownPropertyChoice(value = "GET_TASK",
        label = "Get Task"), @DropdownPropertyChoice(value = "CREATE_TASK",
        label = "Create Task"), @DropdownPropertyChoice(value = "UPDATE_TASK",
        label = "Update Task"), @DropdownPropertyChoice(value = "DELETE_TASK",
        label = "Delete Task"), @DropdownPropertyChoice(value = "LIST_CHECK_LIST_ITEMS",
    ...
    @TemplateProperty(group = "operation",
        ...
        condition = @PropertyCondition(property = "operation.operation",
            oneOf = {"GET_TASK_LIST", "UPDATE_TASK_LIST", "DELETE_TASK_LIST", "LIST_TASKS",
                "GET_TASK", "CREATE_TASK", "UPDATE_TASK", "DELETE_TASK", "LIST_CHECK_LIST_ITEMS",
                "GET_CHECK_LIST_ITEM", "CREATE_CHECK_LIST_ITEM", "UPDATE_CHECK_LIST_ITEM",
    ...
    @TemplateProperty(group = "operation",
        ...
        constraints = @PropertyConstraints(notEmpty = true),
        condition = @PropertyCondition(property = "operation.operation",
            oneOf = {"GET_TASK", "UPDATE_TASK", "DELETE_TASK", "LIST_CHECK_LIST_ITEMS",
                "GET_CHECK_LIST_ITEM", "CREATE_CHECK_LIST_ITEM", "UPDATE_CHECK_LIST_ITEM",
    ...
    @TemplateProperty(group = "operation",
        ...
        constraints = @PropertyConstraints(notEmpty = true),
        condition = @PropertyCondition(property = "operation.operation",
            oneOf = {"GET_CHECK_LIST_ITEM", "UPDATE_CHECK_LIST_ITEM",
