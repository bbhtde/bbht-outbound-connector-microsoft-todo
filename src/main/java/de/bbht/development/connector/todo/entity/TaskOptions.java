...
public record TaskOptions(
    ...
    @TemplateProperty(
			group = "task", label = "Due Date & Time", description = "Date and Time the Task is due",
        condition = @PropertyCondition(property = "operation.operation", oneOf = {"CREATE_TASK"}),
    ...
    @TemplateProperty(
			group = "task", label = "Due Date & Time Timezone",
    ...
    @TemplateProperty(
			group = "task", label = "Completed Date & Time",
    ...
    @TemplateProperty(
			group = "task", label = "Completed Date & Time Timezone",
    ...
    @TemplateProperty(
			group = "task", label = "Reminder Date & Time",
    ...
    @TemplateProperty(
			group = "task", label = "Reminder Date & Time Timezone",
    ...
    @TemplateProperty(
			group = "task", label = "Is Reminder Active?",
