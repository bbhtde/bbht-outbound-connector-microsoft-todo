...
public class OptionMapperTest {
    ...
    void shouldMapNullNonRecurringRecurrence() {
        // given
        var options = new TaskRecurrenceOptions(TaskRecurrenceOptions.VALUE_NON_RECURRING, null, null, null, null, null, null, null, null, null, null, null, null);
        // when
    ...
    void shouldMapRecurrence() {
        // given
        var options = new TaskRecurrenceOptions(TaskRecurrenceOptions.VALUE_RECURRING, null, null, null, null, null, null, null, null, null, null, null, null);
        // when
        var result = OptionMapper.mapPatternedRecurrence(options);
    ...
    void shouldMapPatternRecurrencePatternWithNonEmptyContent(RecurrencePatternTypeDto patternType, Integer dayOfMonth, String daysOfWeek, DayOfWeekDto firstDayOfWeek, WeekIndexDto index, Integer interval, Integer month) {
        // given
        var options = new TaskRecurrenceOptions(TaskRecurrenceOptions.VALUE_RECURRING, patternType, interval, dayOfMonth, daysOfWeek, firstDayOfWeek, index, month, null, null, null, null, null);
    ...
    void shouldMapPatternRecurrenceRangeWithNonEmptyContent(RecurrenceRangeTypeDto rangeType, Integer numberOfOccurrences, String startDate, String endDate, String recurrenceTimeZone) {
        // given
        var options = new TaskRecurrenceOptions(TaskRecurrenceOptions.VALUE_RECURRING, null,null,null,null,null,null,null, rangeType, numberOfOccurrences, startDate, endDate, recurrenceTimeZone);
    ...
    private static Stream<Arguments> provideArgumentsForMapPatternRecurrenceRangeWithNonEmptyContent() {
        return Stream.of(
                Arguments.of(RecurrenceRangeTypeDto.NUMBERED, null, null, null, null),
                Arguments.of(null, 5, null, null, null),
                Arguments.of(null, null, "2024-07-01", null, null),
